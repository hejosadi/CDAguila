    ...
    var fillJuntaCDAguila = function(){
    $.ajax({
    url: strT()+"api/get_page/?page_slug=junta-directiva",
    type: "GET",
    dataType: "jsonp",
timeout: 5000,
...
var getJuntaContent= function(data){
...
mainContent = $('<div></div>').append(mainContent).find('iframe').attr('width', '100%').end().html();
		 ...
		 $("#juntaContenido").html(mainContent);
