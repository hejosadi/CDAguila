    ...
    var fillEstadioCDAguila = function(){
    $.ajax({
    url: strT()+"api/get_page/?page_slug=estadio-juan-francisco-barraza",
    type: "GET",
    dataType: "jsonp",
timeout: 5000,
...
var getEstadioContent= function(data){
...
mainContent = $('<div></div>').append(mainContent).find('iframe').attr('width', '100%').end().html();
		 ...
		 $("#estadioContenido").html(mainContent);
